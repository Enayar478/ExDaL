 ...
 * Détaille la brique technique (API Pennylane côté cabinet) renvoyée par le
 * pilier de la grappe, et fait le pont vers l'offre commerciale et vers le
 * satellite miroir côté dirigeant. CTA qualification, segment cabinet.
 */
export const apiPennylaneCabinetComptable: Article = {
  slug: "api-pennylane-cabinet-comptable",
  ...
  metaDescription:
    "Ce que l'API Pennylane automatise vraiment pour un cabinet : factures, écritures, FEC, multi-dossiers, et ce qu'elle laisse au cabinet de construire.",
  excerpt:
    "L'API Pennylane donne à un cabinet l'accès à une donnée comptable homogène, dossier après dossier : factures, écritures, transactions bancaires, FEC, sans ressaisie. Elle ne fait pas le travail de réconciliation ni de pilotage. Ce guide détaille ce qu'elle permet vraiment, ses limites, et comment un cabinet en fait une offre.",
  ...
  blocks: [
    ...
    {
      type: "p",
      text: "Un cabinet de vingt-deux collaborateurs, quatre-vingt-cinq dossiers sous Pennylane, a testé la bascule sur un lot de trente clients représentatifs du reste du portefeuille (des PME de services, entre cinq et quarante salariés). Avant le projet, l'extraction mensuelle du grand livre et des transactions bancaires pour ces trente dossiers mobilisait environ vingt-huit heures cumulées, réparties sur deux collaborateurs, avant même de commencer l'analyse. Une fois la connexion API mise en place et le script de collecte automatisé, cette même extraction s'est ramenée à moins de deux heures par mois, essentiellement du contrôle de cohérence sur les dossiers qui affichaient une anomalie.",
    },
    {
      type: "stat",
      value: "26 heures",
      label:
        "de temps d'extraction manuelle récupérées chaque mois sur un lot de trente dossiers, une fois l'API branchée.",
    },
    {
      type: "p",
      text: "Le chiffre qui compte n'est pas les heures gagnées en soi, modestes rapportées à un cabinet entier. C'est ce qu'elles sont devenues : du temps de lecture facturable, là où l'extraction manuelle ne l'était jamais.",
    },

    {
      type: "h2",
      id: "limites-api",
      text: "Ce que l'API ne fait pas, et ne fera jamais seule",
    },
    {
      type: "p",
